...
const importedModule$0 = tslib_1.__importStar(require("./sources/hyperlaneoptimism/introspectionSchema.json"));
...
const importFn = (moduleId) => {
    ...
    switch (relativeModuleId) {
        case ".graphclient/sources/hyperlaneoptimism/introspectionSchema.json":
...
async function getMeshOptions() {
    ...
    const hyperlaneoptimismTransforms = [];
    const additionalTypeDefs = [];
    const hyperlaneoptimismHandler = new graphql_1.default({
        name: "hyperlaneoptimism",
        config: { "endpoint": "https://api.studio.thegraph.com/query/50673/hyperlaneoptimism/v0.0.1" },
        baseDir,
        cache,
        pubsub,
        store: sourcesStore.child("hyperlaneoptimism"),
        logger: logger.child("hyperlaneoptimism"),
        importFn,
    });
    sources[0] = {
        name: 'hyperlaneoptimism',
        handler: hyperlaneoptimismHandler,
        transforms: hyperlaneoptimismTransforms
    };
